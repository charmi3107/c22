...
function setup(){
     createCanvas(400,400)
      ...
      world= engine.world; var option ={ restitution:2.0 }
       object=Bodies.circle(100,100,20,option); World.add(world,object);
        var Ground1 ={ isStatic:true }
         ground= Bodies.rectangle(200,400,390,20,Ground1) 
        World.add(world,ground) } function draw(){ background(0)
             ellipseMode(CENTER) 
